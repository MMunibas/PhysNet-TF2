...
calc = NNCalculator(
    checkpoint=["./models/model-1/best_model.ckpt-696000",
                "./models/model-2/best_model.ckpt-654500",
                "./models/model-3/best_model.ckpt-647300",
                "./models/model-4/best_model.ckpt-598500",
                "./models/model-5/best_model.ckpt-711500"], #load the ENSEMBLE of models you want to used
    atoms=atoms,
    charge=args.charge,
    F=128,
    K=64,
