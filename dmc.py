...
#randseed=int(time.time())+os.getpid()+int(os.environ["SLURM_JOB_ID"])
randseed=int(os.environ["SLURM_JOB_ID"])
...
checkpoints = "../../models/model-XXXXX/YYYYY"
Qref = 0.0
max_batch = 6000
...
def log_begin(filename):
    ...
    logfile.write("      Random number seed: " + str(randseed)+"\n")
