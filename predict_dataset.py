...
checkpoints = "./20251006135929_eWhHgX5u_F128K64b5a2i3o1cut10.0e1d1l20.0nh0.01keep1.0/best/best_model.ckpt-1310700"
#checkpoints = "../PhysNet-2/20251006135929_mX62nrlA_F128K64b5a2i3o1cut10.0e1d1l20.0nh0.01keep1.0/best/best_model.ckpt-1286000"
#checkpoints = "../PhysNet-3/20251006135929_Wfx69695_F128K64b5a2i3o1cut10.0e1d1l20.0nh0.01keep1.0/best/best_model.ckpt-1206600"
#checkpoints = "../PhysNet-4/20251006135929_JiQX6jy2_F128K64b5a2i3o1cut10.0e1d1l20.0nh0.01keep1.0/best/best_model.ckpt-1220200"
#checkpoints = "../PhysNet-5/20251006135929_sk4JS13R_F128K64b5a2i3o1cut10.0e1d1l20.0nh0.01keep1.0/best/best_model.ckpt-1212300"
...
with tf.Session() as sess:
    ...
    #print_errors(sess, data_provider.get_train_data,  data_provider.ntrain, "model_1_train", checkpoints)
    
    #calculate errors on valid data
    #print_errors(sess, data_provider.get_valid_data,  data_provider.nvalid, "model_1_valid", checkpoints)
    
    #calculate errors on test data
    print_errors(sess, data_provider.get_test_data,  data_provider.ntest, "model_1_test", checkpoints)
